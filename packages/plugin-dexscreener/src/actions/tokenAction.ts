...
export const priceTemplate = `Determine if this is a token/pair info request. If it is one of the specified situations, perform the corresponding action:

Situation 1: "Get token/pair info"
- Message contains: words like "price", "value", "cost", "worth", "info", "details" AND a token symbol/address
- Example: "What's the price of ETH?" or "Show me BTC details" or "Get info for 0x..."
- Action: Get comprehensive DEX info including price, liquidity, volume, market cap, transaction stats, and pair details
